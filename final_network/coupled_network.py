...
p2h_ctrl_2 = P2HControlMultiEnergy(multinet, p2h_id_el_2, p2h_id_heat_2, cop_factor=cop, out_temp=383.15,
                                   name_power_net="power", name_heat_net="heat")

p2h_ctrl_3 = P2HControlMultiEnergy(multinet, p2h_id_el_3, p2h_id_heat_3, cop_factor=cop, out_temp=383.15,
                                   name_power_net="power", name_heat_net="heat")
