...
# connection 1
p2h_id_el_1 = pandapower.create_load(net_power, bus=17, p_mw=load1, name="power to heat consumption 1")
p2h_id_heat_1 = pandapipes.create_source(net_heat, junction=5, mdot_kg_per_s=0, name="power to heat feed in 1 ")
# connection 2
p2h_id_el_2 = pandapower.create_load(net_power, bus=11, p_mw=load2, name="power to heat consumption 2")
p2h_id_heat_2 = pandapipes.create_source(net_heat, junction=64, mdot_kg_per_s=0, name="power to heat feed in 2")
# connection 3
p2h_id_el_3 = pandapower.create_load(net_power, bus=25, p_mw=load3, name="power to heat consumption 3")
p2h_id_heat_3 = pandapipes.create_source(net_heat, junction=21, mdot_kg_per_s=0, name="power to heat feed in 3")
...
p2h_ctrl_3 = P2HControlMultiEnergy(multinet, p2h_id_el_3, p2h_id_heat_3, cop_factor=4, out_temp=378.15,
                                   name_power_net="power", name_heat_net="heat")
