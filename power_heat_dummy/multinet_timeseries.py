...
import pandapipes
from coupled_network import multinet, p2h_id_el, p2h_id_heat, pipeflow_attributes
...
if __name__ == "__main__":
    ...
    coupled_p2h_const_control(multinet, p2h_id_el, p2h_id_heat, cop_factor=4, out_temp=373.15,
                              name_power_net="power", name_heat_net="heat", profile_name=["load"], data_source=ds)
